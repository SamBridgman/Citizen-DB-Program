...
public class PersonController{
    ...
    public static void addToDatabase(TextField fName, TextField lName) {
        try(PrintWriter fout = new PrintWriter(
                               new BufferedWriter(
                               new FileWriter("dbP.txt", true))))
        {
            ...
            //otherwise write person to db
                ...
                //write to db
                fout.write(lName.getText() + "," + fName.getText() + ",");
                fout.flush();
    ...
    public static PersonRecord[] searchDatabase(TextField searchfName, TextField searchlName) {
        ...
        try (BufferedReader in = new BufferedReader(new FileReader("dbP.txt"))) 
        {
            ...
            while(read.hasNext())
            {
                ...
                if(fName.equalsIgnoreCase(searchfName.getText()) && lName.equalsIgnoreCase(searchlName.getText())) {
                    //this checks if person is criminal or not
                        arr[0] = new Person(fName, lName);//adds person to arr
                        return arr; //return
                }
    ...
    public static void deleteFromDatabase(String sFName, String sLName) {
        ...
        File oldFile = new File("dbP.txt"); // old file which is current db
        ...
        try{
            ...
            FileReader fr = new FileReader("dbP.txt");
    ...
    public static void editDatabase(String sFName, String sLName,String currFName, String currLName) {
        String tempFile = "temp.txt";
        File oldFile = new File("dbP.txt"); // current db to old file
    ...
    public static TableView readDatabase(TableView table){
        try (BufferedReader in = new BufferedReader(new FileReader("dbP.txt"))) //reads database txt file
        {
            ...
            while(read.hasNext()) // there is a next line
            {
                ...
                //add person obj to table
                table.getItems().add(new Person(fName, lName));
